...
export const ClientLogoMarquee: React.FC = () => {
  ...
  return (
    <div className="w-full flex flex-col space-y-6 sm:space-y-8">
      ...
      {/* Dual Row Marquee Container with Subtle Edge Fades */}
      <div className="relative w-full overflow-hidden py-2 space-y-3 sm:space-y-4 select-none group">
        {/* Left & Right gradient masks for editorial fade */}
        <div className="pointer-events-none absolute inset-y-0 left-0 w-12 sm:w-20 bg-gradient-to-r from-white dark:from-[#08080a] to-transparent z-10" />
        <div className="pointer-events-none absolute inset-y-0 right-0 w-12 sm:w-20 bg-gradient-to-l from-white dark:from-[#08080a] to-transparent z-10" />

        {/* Row 1: Right to Left */}
        <div className="flex w-max items-center gap-3 sm:gap-4 animate-marquee group-hover:[animation-play-state:paused] motion-reduce:animate-none">
        ...
        <div className="flex w-max items-center gap-3 sm:gap-4 animate-marquee-reverse group-hover:[animation-play-state:paused] motion-reduce:animate-none">
