  ...
  return (
    <div className="w-full flex flex-col space-y-12 sm:space-y-16 md:space-y-20 pb-16">
      {/* ━━━━━━━━━━━━━━━━━━━━
          SECTION 01 — HERO
          ━━━━━━━━━━━━━━━━━━━━ */}
      <section className="pt-6 sm:pt-8 md:pt-10 px-4 sm:px-8 md:px-12 max-w-7xl mx-auto w-full">
        {/* Massive Editorial Headline */}
        <div className="w-full">
          <h1 className="text-[11vw] sm:text-[9vw] md:text-[7vw] lg:text-[6.4vw] font-display font-medium tracking-tightest leading-[0.98] text-black dark:text-white select-none">
            WE MAKE BRANDS
            <br />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-center mt-6 sm:mt-8 md:mt-10">
          {/* Left Column: Availability, Copy & CTAs */}
          <div className="lg:col-span-6 flex flex-col space-y-4">
            <div className="inline-flex items-center gap-2 text-xs font-mono text-day-muted dark:text-agency-muted">
            ...
            <p className="text-base sm:text-lg md:text-xl text-day-subtext dark:text-agency-subtext font-normal leading-relaxed max-w-xl">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-1">
              <Link
                to="/contact"
                className="inline-flex items-center gap-2.5 px-6 py-3 rounded-full bg-black text-white dark:bg-white dark:text-black text-xs uppercase tracking-widest font-semibold hover:bg-neutral-800 dark:hover:bg-neutral-200 transition-all shadow-sm"
              >
              ...
              <Link
                to="/work"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-full border border-day-border dark:border-agency-border text-black dark:text-white text-xs uppercase tracking-widest font-medium hover:border-black dark:hover:border-white transition-colors"
              >
            ...
            <div className="pt-1 flex flex-wrap gap-2 text-[11px] font-mono text-day-muted dark:text-agency-muted">
              <span className="px-3 py-1 rounded-full border border-day-border dark:border-agency-border bg-day-surface dark:bg-agency-surface">
                Branding & Identity
              </span>
              <span className="px-3 py-1 rounded-full border border-day-border dark:border-agency-border bg-day-surface dark:bg-agency-surface">
                Performance Media
            ...
            >
              <div className="relative aspect-[16/10] overflow-hidden bg-black">
                ...
                <div className="absolute top-4 right-4">
                  <span className="text-[10px] font-mono tracking-widest uppercase px-3 py-1 rounded-full bg-white text-black font-semibold shadow-md">
                    FEATURED CASE
                  </span>
                </div>
              </div>
              <div className="p-4 sm:p-5 border-t border-day-border dark:border-agency-border flex items-center justify-between">
                <div>
                  <h4 className="text-base sm:text-lg font-display font-medium text-black dark:text-white group-hover:text-digitify-purple transition-colors">
                    Brand Campaign Framework
                  </h4>
                  <p className="text-xs font-mono text-day-muted dark:text-agency-muted mt-0.5">
        ...
        <div className="mt-8 sm:mt-10 pt-4 border-t border-day-border/60 dark:border-agency-border/40 flex items-center justify-between text-xs font-mono text-day-muted dark:text-agency-muted">
          <span>SCROLL TO DISCOVER</span>
          <ArrowDown size={14} className="animate-bounce" />
          <span>EST. 2023 · NEW DELHI</span>
        </div>
      </section>
      ...
      {/* ━━━━━━━━━━━━━━━━━━━━
          ...
          ━━━━━━━━━━━━━━━━━━━━ */}
      <section className="px-4 sm:px-8 md:px-12 max-w-7xl mx-auto w-full">
        <div className="border-t border-day-border dark:border-agency-border pt-10 sm:pt-12 md:pt-14">
        ...
        <div className="border-t border-day-border dark:border-agency-border pt-10 sm:pt-12 md:pt-14">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12">
            <div className="lg:col-span-8">
              <h2 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-display font-medium tracking-tight leading-[1.08] text-black dark:text-white mb-5">
                BUILT FOR BRANDS
                <br />
                THAT WANT TO MOVE<span className="text-digitify-purple">.</span>
              </h2>

              <p className="text-lg sm:text-xl md:text-2xl text-black dark:text-white font-normal leading-relaxed mb-4">
              ...
              <p className="text-sm sm:text-base text-day-subtext dark:text-agency-subtext leading-relaxed max-w-2xl">
            ...
            <div className="lg:col-span-4 flex flex-col justify-between space-y-5 lg:border-l lg:border-day-border dark:lg:border-agency-border lg:pl-8">
              <div className="space-y-4">
                <div className="border-b border-day-border/60 dark:border-agency-border/60 pb-3">
                  ...
                  <p className="text-sm sm:text-base font-display text-black dark:text-white mt-1">
      ...
      {/* ━━━━━━━━━━━━━━━━━━━━
          ...
          ━━━━━━━━━━━━━━━━━━━━ */}
      <section className="px-4 sm:px-8 md:px-12 max-w-7xl mx-auto w-full">
        <div className="border-t border-day-border dark:border-agency-border pt-14 sm:pt-18 pb-6 text-center flex flex-col items-center">
          <span className="text-xs font-mono uppercase tracking-widest text-day-muted dark:text-agency-muted block mb-3">
            LET’S COLLABORATE
          </span>
          <h2 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-display font-medium tracking-tightest leading-[1] text-black dark:text-white max-w-4xl mb-4">
            LET’S BUILD
            <br />
            SOMETHING REMARKABLE<span className="text-digitify-purple">.</span>
          </h2>
          <p className="text-sm sm:text-base md:text-lg text-day-subtext dark:text-agency-subtext max-w-xl mb-8 leading-relaxed">
            Have a brand, campaign or digital idea in mind? Let’s turn it into something people remember.
          </p>

          <Link
            to="/contact"
            className="inline-flex items-center gap-3 px-8 py-3.5 rounded-full bg-black text-white dark:bg-white dark:text-black text-xs uppercase tracking-widest font-semibold hover:bg-neutral-800 dark:hover:bg-neutral-200 hover:scale-105 transition-all shadow-md"
          >
            <span>Start a Project</span>
            <ArrowRight size={15} />
          </Link>
